...
export default class Home extends Component {
  ...
  addPost() {
    UserStoreActions.insertPost(1, this.state.ptitle, this.state.text);
  }

  addTodo() {
    UserStoreActions.insertTodo(1, this.state.ttitle, this.state.completed)
  }
