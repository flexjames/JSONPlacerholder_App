...
export default class Home extends Component {
  ...
  addPost() {
    UserStoreActions.insertPost(3, this.state.ptitle, this.state.text);
  }

  addTodo() {
    UserStoreActions.insertTodo(3, this.state.ttitle, this.state.completed)
  }
